...
export function PatientRegistrationForm() {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      bloodGroup: "",
      pregnancyWeek: undefined as any,
      ...
      preeclampsiaFamilyHistory: false,
      symptoms: "",
    },
  });
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Enter the patient's comprehensive medical details below.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
